      ...
      <div className='w-full flex flex-col px-[1rem] md:px-[5rem] py-[4rem] z-10'>
        ...
        <div className='w-full flex flex-wrap justify-center items-center mb-[4rem] space-y-4 md:space-y-0'>
          {stats.map((stat, index) => (
            ...
            >
              <h3 className='text-[2rem] md:text-[2.5rem] font-bold text-brand-accent'>{stat.number}</h3>
        ...
        <div className='w-full flex flex-col items-center mb-[4rem] space-y-6'>
          <h2 className='text-[2rem] md:text-[2.5rem] font-light text-center text-green-400'>Our Mission</h2>
        ...
        {/* Core Services */}
        <div className='w-full flex flex-col items-center mb-[4rem] space-y-6'>
          <h2 className='text-[2rem] md:text-[2.5rem] font-light text-center text-green-400'>What We Deliver</h2>
          <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-[2rem]'>
            <div className='bg-card-bg p-[2rem] rounded-xl text-center space-y-4'>
              <h3 className='text-[1.2rem] font-semibold text-brand-accent'>Lightning-Fast Development</h3>
            ...
            <div className='bg-card-bg p-[2rem] rounded-xl text-center space-y-4'>
              <h3 className='text-[1.2rem] font-semibold text-brand-accent'>Powerful SaaS Products</h3>
              <p className='text-[0.8rem] text-[#dad4e4]'>Scalable software-as-a-service solutions that grow with your business needs.</p>
            </div>
            <div className='bg-card-bg p-[2rem] rounded-xl text-center space-y-4'>
              <h3 className='text-[1.2rem] font-semibold text-brand-accent'>AI-Driven Solutions</h3>
              <p className='text-[0.8rem] text-[#dad4e4]'>Intelligent AI chatbots and automation that solve real-world business problems.</p>
            </div>
            <div className='bg-card-bg p-[2rem] rounded-xl text-center space-y-4'>
              <h3 className='text-[1.2rem] font-semibold text-brand-accent'>Platform Engineering</h3>
        ...
        {/* Team Section */}
        <div className='w-full flex flex-col items-center mb-[4rem] space-y-6'>
          <h2 className='text-[2rem] md:text-[2.5rem] font-light text-center text-green-400'>Meet Our Leadership</h2>
        ...
        <div className='w-full flex flex-wrap justify-center items-start mb-[4rem]'>
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className='w-full sm:w-[45%] md:w-[45%] m-[1rem] bg-card-bg p-[2rem] rounded-xl hover:scale-105 transition-transform duration-300 hover:shadow-xl flex flex-col items-center space-y-[1.5rem]'
            >
              <img
                src={member.image}
                alt={member.name}
                className='rounded-full w-[8rem] h-[8rem] md:w-[10rem] md:h-[10rem] object-cover border-4 border-brand-accent'
              />
              <div className='text-center space-y-2'>
                <h3 className='text-[1.5rem] text-white font-semibold'>{member.name}</h3>
                <p className='text-[1rem] text-brand-accent font-medium'>{member.title}</p>
        ...
        <div className='w-full flex flex-col items-center space-y-6'>
          <h2 className='text-[2rem] md:text-[2.5rem] font-light text-center text-green-400'>Ready to Move at Hyperspeed?</h2>
          <p className='text-[0.9rem] md:text-[1rem] font-light text-[#dad4e4] text-center max-w-2xl'>
