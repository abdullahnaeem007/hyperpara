      ...
      <div className="w-full flex flex-col md:flex-row px-[1rem] md:px-[5rem] py-[4rem] z-10">
        ...
        <div className="w-full md:w-[60%] flex flex-col space-y-6 pr-[0rem] md:pr-[3rem]">
          <div className="space-y-4">
            <h2 className="text-[2rem] md:text-[2.5rem] font-light text-green-400">
              Let's Build Something Amazing
            </h2>
            <p className="text-[0.9rem] md:text-[1rem] font-light text-[#dad4e4]">
              Ready to accelerate your digital growth? Tell us about your
          ...
          {submitStatus === "error" && (
            <div className="bg-red-500/20 border border-red-500 text-red-400 px-4 py-3 rounded-lg">
              ...
              or email us directly at info@hyperpara.co
            </div>
          )}
          ...
          <form ref={form} onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-[0.9rem] text-white mb-2">
                  Name *
                </label>
                <input
                  type="text"
        ...
        <div className="w-full md:w-[40%] flex flex-col space-y-8 mt-[3rem] md:mt-0">
          <div className="space-y-4">
            <h3 className="text-[1.5rem] font-semibold text-green-400">
              Get in Touch
            </h3>
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => (
              <div key={index} className="space-y-2">
                <h4 className="text-[1.1rem] font-semibold text-brand-accent">
                  {info.title}
                </h4>
                {info.title === "Email" ? (
                  <Link
          ...
          <div className="space-y-4">
            ...
            <p className="text-[0.9rem] text-[#dad4e4]">
              ...
              projects, please mention "URGENT" in your message.
            </p>
          </div>
        </div>
      </div>
